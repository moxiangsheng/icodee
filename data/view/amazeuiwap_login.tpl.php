...
<section class="am-container" >
  ...
  <input type="hidden" name="forward" value="<?=$forward?>"/>
    ...
    <p class="am-cf"><a href="<?=SITE_URL?>?user/register.html" class="am-fl">注册</a> <a href="<?=SITE_URL?>?user/getpass.html" class="am-fr">忘记密码</a></p>
 ...
 <p>
         <? if($setting['sinalogin_open']) { ?>         
                ...
                <? } ?>                <? if($setting['qqlogin_open']) { ?>                <span><a href="<?=SITE_URL?>plugin/wapqqlogin/index.php"><img src="<?=SITE_URL?>static/css/default/qq_login_btn.png" alt="Connect_logo_3.png"></a></span>
              
                <? } ?>                
                 <? if($wxbrower) { ?>                  <span><a href="<?=SITE_URL?>?plugin_weixin/wxauth"><img src="<?=SITE_URL?>static/css/default/wx.jpg" style="width:24px;height:24px;margin-left:10px;" alt="微信登录"></a></span>
